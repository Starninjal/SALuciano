...
public class ViewCadastroMecanico extends JFrame {
	...
	public ViewCadastroMecanico() {
		...
		lblNomeMecanico_1.setFont(new Font("Dialog", Font.BOLD, 21));
		lblNomeMecanico_1.setBounds(10, 153, 210, 19);
		contentPane.add(lblNomeMecanico_1);
		
		txtNomeMecanico = new JTextField();
		txtNomeMecanico.setColumns(10);
		txtNomeMecanico.setBounds(183, 143, 331, 46);
		...
		btnNewButton.setBounds(185, 308, 179, 41);
